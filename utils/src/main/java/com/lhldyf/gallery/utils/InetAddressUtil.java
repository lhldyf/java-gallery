...
public class InetAddressUtil {
    ...
    public static int toAbsInt(String ipAddress) throws UnknownHostException  {
        return Math.abs(toInt(ipAddress));
    }
    ...
    public static String getLocalHostIp() throws UnknownHostException{
        return getIp(getLocalHostLANAddress());
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        System.out.println("fuck address is " + address + " and to int is "
                                   + toInt(address));
        System.out.println(getIp(address));
        System.out.println(getLocalHostIp());

        System.out.println(toInt("172.31.99.5"));
        System.out.println(toAbsInt("172.31.99.5") % 10);

        System.out.println(toIp(-1407229179));
